...
console.log("SELECCIÒN MÙLTIPLE CON IF");
let dia = "dd";
if (dia == "lunes")
{
...
console.log("SELECCIÒN MÙTLIPLCE CON SWITCH");
let dia = "sabado";
switch(dia)
{
 case "lunes":
...
console.log("REPETICIÒN CICLOS FOR");
for (let i = 1; i <= 5; i++)
{
 console.log("Hola: " + i);
}
...
console.log("REPETICIÓN CICLOS WHILE");
let contador = 1;
while (contador <= 5)
{
...
console.log("REPETICIÒN CICLOS DO-while");
let numero = 0;
do {
